    ...
    return (
        <div className="space-y-6 relative rounded-3xl p-6 overflow-hidden">
            ...
            <div className="grid grid-cols-3 gap-6">
                ...
                <Card className="rounded-3xl border border-white/5 bg-zinc-950/40 backdrop-blur-2xl shadow-2xl relative overflow-hidden group hover:border-orange-500/30 transition-all duration-500">
                ...
                <Card className="rounded-3xl border border-white/5 bg-zinc-950/40 backdrop-blur-2xl shadow-2xl relative overflow-hidden group hover:border-red-500/30 transition-all duration-500">
                ...
                <Card className="rounded-3xl border border-white/5 bg-zinc-950/40 backdrop-blur-2xl shadow-2xl relative overflow-hidden group hover:border-amber-500/30 transition-all duration-500">
            ...
            <div className="grid grid-cols-12 gap-6">
                ...
                <div className="col-span-4">
                    <Card className="rounded-3xl border border-white/5 bg-zinc-950/40 backdrop-blur-2xl shadow-2xl h-full overflow-hidden relative group hover:border-white/10 transition-all duration-500">
                ...
                <div className="col-span-12">
                    <Card className="rounded-3xl border border-white/5 bg-zinc-950/40 backdrop-blur-2xl shadow-2xl relative overflow-hidden group hover:border-white/10 transition-all duration-500">
